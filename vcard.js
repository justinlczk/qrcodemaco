(function(context) {
    ...
    var vCard = {
        ...
        Entry: {
            ...
            "FORMATTEDNAME": {"version": [version.TWO, version.THREE, version.FOUR], "key": "FN;CHARSET=UTF-8;"},
            ...
            "NAME": {"version": [version.TWO, version.THREE, version.FOUR], "key": "N;CHARSET=UTF-8", "format": "{1};{0};;{2}", "@comment": "usage: addName(firstname, lastname, title)"},
            ...
            "TITLE": {"version": [version.TWO, version.THREE, version.FOUR], "key": "TITLE;CHARSET=UTF-8"},
            ...
            for(var key in card) {
                ...
                if(Object.prototype.toString.call(entry) === "[object Array]") {
                    for(var i = 0, l = entry.length; i < l; i++) {
                        var e = entry[i]
                        if(key.toUpperCase() == "ADR") {
                        str += key.toUpperCase() + (e.type ? "; WORK; CHARSET=UTF-8,PREF:" : ":") + e.value + "\n"
                        }
                        else {
